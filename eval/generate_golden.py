...
Usage:
    python eval/generate_golden.py --n 30 --seed 7 \
        --endpoint http://localhost:4004/v1 --model unsloth/Qwen3.6-35B-A3B-MTP-GGUF
"""
...
def main() -> int:
    ...
    for n in notes:
        ...
        q = ""
# Retry with backoff: llama-swap returns 503 while a model is still loading,
# and reasoning models need a couple of attempts' patience — don't write a
# note off on the first error.
